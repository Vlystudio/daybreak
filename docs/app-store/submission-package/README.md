...
Recheck those pages at submission because Apple changes fields and rating values.

## Files

- `metadata.md` — name, subtitle, promotion, description, keywords, categories, and What’s New.
- `age-rating-and-export.md` — current questionnaire/18+ override and encryption worksheet.
- `privacy-and-permissions.md` — privacy answers, account rationale, optional permissions, and URLs.
- `review-notes.md` — reviewer flow, demo credentials/data, deletion, AI, HealthKit, and subscription N/A.
- `support-and-marketing.md` — required support/marketing page content.
