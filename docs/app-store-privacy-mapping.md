...
| Location — Coarse Location                                                                   | Approximate coordinates derived from a user-entered city                   |    Optional |                                            Yes | App Functionality                                             | Stored for weather; no device or background location permission is requested.              |
