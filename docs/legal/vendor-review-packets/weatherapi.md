# WeatherAPI.com approval packet
...
| -------------------------- | --------------------------------------------------------------------------------------------- |
| Purpose                    | Local weather for planning                                                                    |
...
| Emergency disable          | Remove WEATHER_API_KEY and redeploy to independently approved fallback or no-weather behavior |
