# ŌURA Health Oy approval packet
...
| Emergency disable          | Remove OURA client credentials, disable provider registry entry, and preserve encrypted grants for controlled revocation |
