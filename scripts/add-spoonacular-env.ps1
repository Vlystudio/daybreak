# Adds SPOONACULAR_API_KEY to Vercel via the REST API.
# Reads value + token from .env.local. Leaves all other env vars untouched.
# Run from project root:  .\scripts\add-spoonacular-env.ps1
